        ...
        <div className="min-h-screen flex items-center justify-center bg-[#dff2ff] px-4">
            ...
            <div className="relative w-full max-w-md rounded-3xl border border-sky-200/70 bg-white/70 backdrop-blur p-6 shadow-2xl shadow-slate-900/10">
                <div className="mb-6">
                    ...
                    <p className="mt-1 text-sm text-slate-600">Log in to continue to your projects.</p>
                </div>
                <form
                ...
                <p className="mt-4 text-sm text-slate-600">
                    ...
                    <Link to="/register" className="font-medium text-sky-700 hover:text-sky-800 underline-offset-4 hover:underline">
                        Create one
                    </Link>
                </p>
            </div>
